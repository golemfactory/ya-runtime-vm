...
./vmrt \
  ...
  -drive file=/home/aljen/.local/lib/yagna/plugins/ya-runtime-vm/runtime/self-test.gvmi,cache=unsafe,readonly=on,format=raw,id=rootfs-0,if=none \
  -device virtio-blk-pci,drive=rootfs-0,serial=rootfs-0 \
  -drive file=/home/aljen/.local/lib/yagna/plugins/ya-runtime-vm/runtime/self-test-layer-1.gvmi,cache=unsafe,readonly=on,format=raw,id=rootfs-1,if=none \
  -device virtio-blk-pci,drive=rootfs-1,serial=rootfs-1 \
  -drive file=/home/aljen/.local/lib/yagna/plugins/ya-runtime-vm/runtime/self-test-layer-2.gvmi,cache=unsafe,readonly=on,format=raw,id=rootfs-2,if=none \
  -device virtio-blk-pci,drive=rootfs-2,serial=rootfs-2 \
  -vga none \
